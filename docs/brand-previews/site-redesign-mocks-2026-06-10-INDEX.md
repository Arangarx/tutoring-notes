...
| 6 | [whiteboard-mobile-mock-2026-06-10.html](whiteboard-mobile-mock-2026-06-10.html) | Live whiteboard (mobile/tablet) | Portrait-primary phone; persistent tools toggle; sample board canvas; button-driven sheets; fuller tier-1; tutor-primary AV pip; student laser (cyan vs coral). |
