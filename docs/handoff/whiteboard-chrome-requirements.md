...
| **ST-04** | Student does **not** need full shape/text toolset by default — tutor drives structure. **Tier-1 student tools** per **TB-12** (Pencil · Eraser · Shapes▾ · Styles · Wand · ⋮); **Shapes▾** tier-1 for geometry/graphing (no bar-size cost); **Select** in overflow only. Text and inserts remain overflow/tutor-driven. | (ii) | v1 §5.7; RELIABILITY-REDESIGN; mobile review 2026-06-10 |
...
4. **Student vs tutor tool parity:** **Partially resolved 2026-06-10** — phone tier-1 calibration in **TB-12** (student: Pencil/Eraser/Shapes▾/Styles/Wand/⋮; phone tutor adds Select). Full desktop parity still deferred; student add-page remains v1 no.
