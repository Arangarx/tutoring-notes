...
| **ST-02** | Student bottom bar ~48px: **follow toggle, mic, leave** — above compact **board** strip (bottom placement per **SR-06**). | (ii) | v1 §5.7 |
