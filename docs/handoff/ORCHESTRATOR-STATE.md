...
## ⏩ HEAD — 2026-07-02: PART 3 EXECUTION UNDERWAY (overnight autonomous, Sonnet executor). **`p3-clock` LANDED @ [`1572983`](https://github.com/Arangarx/tutoring-notes/commit/1572983)**; **`p3-perspeaker-capture` FOUNDATION (sub-steps A+B) LANDED** — A schema+transcription labels [`e92c9ac`](https://github.com/Arangarx/tutoring-notes/commit/e92c9ac), B replay-isolation [`8638c86`](https://github.com/Arangarx/tutoring-notes/commit/8638c86), LIVE-AV #6a [`1df3258`](https://github.com/Arangarx/tutoring-notes/commit/1df3258). **⚠️ perspeaker sub-step C (live per-speaker recorder wiring + per-speaker transcription enqueue) DEFERRED — needs Andrew design-fork confirm (see Open Andrew-confirms: PERSPEAKER-C-TRANSCRIPTION-TRIGGER).** NOW pivoting to **`p3-model-abstraction`** (independent of C, low-risk, serves notes-quality pre-merge bar). Andrew asleep — mandate: maximal SAFE progress, test everything jest/playwright-testable, do NOT gamble fragile unsmoked changes into the hardware-smoke tree. Perceptual items (audio↔stroke alignment, real WebRTC audio, VAD, mixdown) are hardware-smoke-only by the testing contract.
