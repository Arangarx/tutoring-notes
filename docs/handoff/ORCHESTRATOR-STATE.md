...
| **Open v1 requirements** | **Light/dark parity + persisted user-facing theme toggle** — pre-master gate (tracked: `BACKLOG.md` § V1 redesign, `V1-COMPONENT-LIBRARY.md` §2.11, whiteboard **TU-12**). |
