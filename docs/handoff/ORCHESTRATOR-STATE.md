...
- **RATIFY:** IAC-13 design Q1–Q8 (`design/iac-13-tutor-disconnect` @ `d8996bb`) — all have recommended defaults; build slots into identity Phase 2/3.
- **HARDWARE-VERIFY:** session-lifecycle P0 — run H1 (draw-during-disconnect) + H3 (Pause-vs-timer) from the pause/disconnect analysis (`analysis/pause-disconnect-behavior` @ `0d0604c`); unblocks the freeze-vs-advance design decision.
