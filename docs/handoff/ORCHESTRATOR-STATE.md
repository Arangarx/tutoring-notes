...
## ⏩ HEAD — 2026-06-16 Phase 1 merged @ [`f68053c`](https://github.com/Arangarx/tutoring-notes/commit/f68053c); Phase 2 execution started
...
| **Next action(s)** | **(1) P2 student-on-new-shell — IN FLIGHT** on `phase2/wb-student-new-shell` (forked off merged `v1-redesign` @ `f68053c`). Executor implementing per [`phase-2-student-on-new-shell-plan-2026-06-16.md`](phase-2-student-on-new-shell-plan-2026-06-16.md) + [`phase-2-student-on-new-shell-5axis-2026-06-16.md`](phase-2-student-on-new-shell-5axis-2026-06-16.md). Scope: `/w/[joinToken]` through unified shell `role=student`, straight-to-live, mobile-first, self-view ON, flag `NEXT_PUBLIC_WB_STUDENT_NEW_SHELL`, legacy backup. Blockers folded @ [`80ac571`](https://github.com/Arangarx/tutoring-notes/commit/80ac571): B1 wb-sync flag-ON + E2E bridge; B2 stable-ref `initialData`; B3 `WbAVCluster` recording-context dep audit; B4 static recording disclosure. **(2)** `phase1/wb-reliability-floor` @ `d63ac22` — merge after Andrew **DESKTOP** smoke (1b audio-clock; iOS tighten-pass deferred-safe, not merge gate). **(3)** Ship-to-Sarah gate (SSG-1/2/3, F1) — folds into P2/P3 + backend pass. **(4)** `Experience-Driven Wedge` rolling-wave + consent v2 when Andrew prioritizes. **Decision pending:** WB-NEW-SESSION-FALSE-RECOVERY — pre-master vs post-master. **Deferred post-master (BACKLOG):** WB-DRY-VIEWPORT, WB-REVIEW-TRANSITION, WB-IMPERSONATION-SESSION, WB-ERASE-RELIABILITY, WB-NEW-SESSION-FALSE-RECOVERY, WB-COMPONENTS-PASS, WB-AV-VIDEO-PAINT-REAL-FIX. |
...
| **In-flight subagents** | **P2 executor (Composer 2.5)** — `phase2/wb-student-new-shell`, implementing student-on-new-shell per merged plan @ [`80ac571`](https://github.com/Arangarx/tutoring-notes/commit/80ac571). Login-friction/auth thread **CLOSED** @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344). |
...
| **P2 student-on-new-shell (ACTIVE 2026-06-16)** | **EXECUTING** on `phase2/wb-student-new-shell` (forked off `v1-redesign` @ `f68053c`). Plan [`f9355cc`](https://github.com/Arangarx/tutoring-notes/commit/f9355cc) → 5-axis [`26d6211`](https://github.com/Arangarx/tutoring-notes/commit/26d6211) → blockers folded [`80ac571`](https://github.com/Arangarx/tutoring-notes/commit/80ac571) (merged into `v1-redesign`). Docs: [`phase-2-student-on-new-shell-plan-2026-06-16.md`](phase-2-student-on-new-shell-plan-2026-06-16.md) + [`phase-2-student-on-new-shell-5axis-2026-06-16.md`](phase-2-student-on-new-shell-5axis-2026-06-16.md). **Q1/Q7 resolved** (see Open Andrew-confirms). |
