...
| **Open v1 requirements** | **Theme-agnostic token-driven components (no light/dark in component code); N-theme-capable** — per-component build standard (no separate pass); theme plumbing + toggle slot into component-pass **first slice** (A′); enforced via `V1-COMPONENT-LIBRARY.md` §2.11 HARD gate + `.cursor/rules/both-theme-components.mdc` (tracked: `BACKLOG.md` § V1 redesign, whiteboard **TU-12**). **Parked (Andrew 2026-06-10):** (1) **B2** — per-tutor privacy re-consent at claim/reconnect ([`authed-session-access-design-2026-06-10.md`](authed-session-access-design-2026-06-10.md) §9.1); (2) **Phase 2** — notes page inside authenticated parent/child chrome, navigable not dead-end ([`authed-session-access-design-2026-06-10.md`](authed-session-access-design-2026-06-10.md) §4.10). |
