...
| **Uncommitted / unmerged** | **`wb-wave5-polish` @ [`f6ad4bc`](https://github.com/Arangarx/tutoring-notes/commit/f6ad4bc)** (+ this docs commit on top) — Block B + CC-1 + CC-2 + **erasure E1–E8 ALL COMPLETE**, all pushed; **NOT merged** to `v1-redesign` (awaiting Andrew merge-gate decision). **`v1-redesign` @ `7397abc`** unchanged. |
