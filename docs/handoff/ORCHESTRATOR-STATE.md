...
## ⏩ HEAD — 2026-06-17 Phase 1 merged @ [`f68053c`](https://github.com/Arangarx/tutoring-notes/commit/f68053c); Phase 2 COMPLETE+smokeable @ [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca) (awaits Andrew smoke); P3 plan+5axis execute-ready (awaits P2 smoke+greenlight)

> **✅ RESOLVED — Live-A/V video-paint saga (institutional memory).** **KNOWN-GOOD checkpoint [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae):** Mechanisms A (`WbAVCluster` auto-fires `setSize`+`setUserResized` on remote-video arrival) + B (`AVTile` `ResizeObserver` + `offsetHeight` flush) — **Andrew-CONFIRMED** paints tutor's remote student video on arrival without manual resize. **DO NOT LOSE.** Principled CSS-only fix [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) **FAILED on-device** ("video does not show up without resize"); bandaid restored @ [`1cc268d`](https://github.com/Arangarx/tutoring-notes/commit/1cc268d) (5 AV files reverted to `3b996ae` versions). **Shipped state = bandaid.** Real fix backlogged **WB-AV-VIDEO-PAINT-REAL-FIX** (tied to WB-COMPONENTS-PASS). LV-2 treated satisfied — [`1cc268d`](https://github.com/Arangarx/tutoring-notes/commit/1cc268d) is byte-identical AV code to Andrew-confirmed [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae). Fix chain for archaeology: [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8) → [`40b3130`](https://github.com/Arangarx/tutoring-notes/commit/40b3130) → [`a3a94f7`](https://github.com/Arangarx/tutoring-notes/commit/a3a94f7) → [`e2c290a`](https://github.com/Arangarx/tutoring-notes/commit/e2c290a) → [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) (WORKS) → [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) (failed) → [`1cc268d`](https://github.com/Arangarx/tutoring-notes/commit/1cc268d) (bandaid restored, merged).

| Field | Value |
|---|---|
| **Last action completed (2026-06-16)** | **MILESTONE — Phase 1 replay-in-frame MERGED into `v1-redesign`** @ [`f68053c`](https://github.com/Arangarx/tutoring-notes/commit/f68053c) (`git merge --no-ff phase1/wb-review-correct`, pushed). Branch `phase1/wb-review-correct` **merged** (preserve for later cleanup). **Pre-merge gates passed:** `npx next build` exit 0; `npm run test:wb-sync` Playwright/relay invariants green; wb-jest **659/659** @ [`6440ea7`](https://github.com/Arangarx/tutoring-notes/commit/6440ea7) (4 test-only blockers fixed: replay-audio FIX1 stale-expectation reconciled to [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08) pass-through behavior + SharePage ThemeProvider mock — production share pages wrapped via root layout `<Providers>`, no regression). Known-pre-existing `broadcastSignal` throttle test remains acceptable. **Phase 2 execution STARTED:** Andrew greenlit ("merge phase 1 and start on the phase 2 plan execution"); orchestrator resolved P2 confirms — **Q1 → FORK** `phase2/wb-student-new-shell` off merged `v1-redesign` (NOT stacked on phase1); **Q7 `defaultShowLocalVideo` flip → P2 smoke item 15**, not a start blocker. P2 plan execute-ready @ [`80ac571`](https://github.com/Arangarx/tutoring-notes/commit/80ac571) (now merged into `v1-redesign`); Composer executor dispatched on `phase2/wb-student-new-shell`. **P1 highlights (now on `v1-redesign`):** in-frame unified review surface; replay seek-on-load [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08); replay CTA layout [`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8); late-add A/V renegotiation [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20); video-paint bandaid @ [`1cc268d`](https://github.com/Arangarx/tutoring-notes/commit/1cc268d). Smokebook [`phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md`](phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md) — Andrew actively entering results (**do NOT edit**). *(Prior milestones — login-friction/auth @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344); `v1-design-system` @ [`36727ea`](https://github.com/Arangarx/tutoring-notes/commit/36727ea).)* |
...
| **Next action(s)** | **(1) ⏸ P2 student-on-new-shell — COMPLETE + smokeable, AWAITS ANDREW SMOKE.** Branch `phase2/wb-student-new-shell` @ [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca). All gates green: tsc, eslint, jest **660**, full `test:wb-sync` **13 pass / 1 pre-existing PDF skip (B1 flag-ON satisfied)**, `next build` exit 0. All 4 folded blockers met (B1 E2E bridge+wb-sync; B2 stable `initialData`; B3 WbAVCluster no recording-FSM dep; B4 disclosure banner); NO tutor-engine behavioral changes. **Andrew action: set `NEXT_PUBLIC_WB_STUDENT_NEW_SHELL=1` on the branch Preview, then run two-device smokebook** [`phase-2-student-new-shell-smokebook-2026-06-16.md`](phase-2-student-new-shell-smokebook-2026-06-16.md) (items 0–15; #15 = Q7 tutor self-view no-regression). Preview: [phase2 @ Vercel](https://tutoring-notes-git-phase2-wb-stu-9fb9ae-arangarx-5209s-projects.vercel.app). **On PASS → `merge --no-ff` into `v1-redesign`.** **(2) P3 PLAN + 5-AXIS DONE — execute-ready pending greenlight.** Plan [`58ca872`](https://github.com/Arangarx/tutoring-notes/commit/58ca872) [`phase-3-waiting-room-plan-2026-06-16.md`](phase-3-waiting-room-plan-2026-06-16.md) (3 pillars: lifecycle state machine + additive migration → mutual waiting room UI → consent hook-in + retire click + destructive Neon migration LAST). Independent 5-axis [`0c92644`](https://github.com/Arangarx/tutoring-notes/commit/0c92644) [`phase-3-waiting-room-5axis-2026-06-16.md`](phase-3-waiting-room-5axis-2026-06-16.md): **verdict NOT-READY → 5 BLOCKERs folded into acceptance P3-A1–P3-A5** (B1 migration backfill `WHERE sessionPhase='pending'` not `IS NULL` — else Sarah's historical sessions break; B2 `assertConsentFromLiveRecord` notes-email path missing from `CONSENT_ENFORCEMENT` deletion inventory; B3 pending-create not flag-gated → "flag off = legacy straight-to-live" broken; B4 `active-ping` stamps timer without `sessionPhase` check → billable clock in waiting; B5 `cancelPendingSession` unspecified) + 6 MAJORs (resolve before merge). **P3 EXECUTION gated on (a) P2 smoke+merge AND (b) explicit Andrew greenlight** (destructive Neon test-account forward-migration + unconditional consent enforcement — not unattended). **NEW open Andrew-Qs: §9 Q1–Q12** (account inventory; delete-vs-killswitch `CONSENT_ENFORCEMENT`; waiting-room flag; timer display; force-start; mode-picker; learner-required timing; `consentAcknowledged` fate; authed `/join` scope; unclaimed-student error UX; §6.4 backup hard-gate; env-var cleanup timing). **(3)** `phase1/wb-reliability-floor` @ `d63ac22` — merge after Andrew **DESKTOP** smoke (1b audio-clock; iOS tighten-pass deferred-safe, not merge gate). **(4)** Ship-to-Sarah gate (SSG-1/2/3, F1) — folds into P2/P3 + backend pass. **(5)** `Experience-Driven Wedge` rolling-wave + consent v2 when Andrew prioritizes. **Decision pending:** WB-NEW-SESSION-FALSE-RECOVERY — pre-master vs post-master. **Deferred post-master (BACKLOG):** WB-DRY-VIEWPORT, WB-REVIEW-TRANSITION, WB-IMPERSONATION-SESSION, WB-ERASE-RELIABILITY, WB-NEW-SESSION-FALSE-RECOVERY, WB-COMPONENTS-PASS, WB-AV-VIDEO-PAINT-REAL-FIX. |
| **Plan sequencing (confirmed 2026-06-16, explore archaeology)** | [`live_session_floor`](../../../.cursor/plans/live_session_floor_2e662852.plan.md) (P1 in-frame review ✅merged → P2 student-shell ✅smokeable → P3 waiting room+consent) is a **UX-first tactical re-sequencing of wedge Phase 1 (WB reliability floor)**, NOT 1:1 — wedge Phase 1 also has parallel/out-of-band items (1b audio-clock side branch; full Gate-A burndown; ship-to-Sarah backend overlay). After floor P1–P3 + parked backend spine (**A6-1** multi-segment replay; 1b merge; note-quality) → master cut → **wedge Phase 2 (continuity engine) → 3 (note-quality) → 4 (instrumentation)**. **A6-1 = Gate A6 (replay fidelity) sub-item = multi-segment replay scrubber/seek correctness** (recordings split into N audio chunks, e.g. >50-min; the case Sarah hit). Single-segment fixed in P1; multi-segment DEFERRED — cross-linked to backlog **SSG-3** (SSG-3 is broader: multi-seg mapping + legacy `WhiteboardReplay` retirement). Canonical gate list: `ORCHESTRATOR-STATE.md` § Pre-master gates two-tier checklist. Interleave to watch: note-quality is wedge **Phase 3** formally but parked in floor + elevated as #1 post-cut follow-up. |
| **Open Andrew-confirms** | **Resolved 2026-06-14** ([`71b2c3e`](https://github.com/Arangarx/tutoring-notes/commit/71b2c3e)): **(c)** student URL → **KEEP (hybrid)** — do NOT retire anonymous `/w/[joinToken]` paste-and-go; stays as fallback (esp. unclaimed students); claimed/logged-in → authed `/join/[sessionId]` design intent. **(e)** camera default → **SELF-VIEW ON** — student + tutor see own camera by default. **Resolved 2026-06-16 (P2):** **Q1** branch strategy → **FORK** `phase2/wb-student-new-shell`; **Q7** `defaultShowLocalVideo` → P2 smoke item 15. **Product decisions 2026-06-14:** live WB **single-tab by default** (separate tab = future desktop-only opt-in `BL-WB-SEPARATE-TAB-OPTIN`; iOS background-tab suspension wedges recorder). WB wordmark → student detail while LIVE = guarded leave-session (`BL-WB-WORDMARK-NAV` backlogged). **Standing:** **(d)** learner-swap · **(f)** C1–C4 before `CONSENT_ENFORCEMENT` flip · **(g)** env scoping at master cut · B2 D-1/D-2/D-5 · B1 deferred TODOs · N-2. **P1 replay confirmed:** replay first-play at 0:00; live+replay center; thumbnail-pin + button layout; #5 audio pause; hard-refresh scrub; delete warning; notes/form dock; LV-1; video paint bandaid; idempotency #13 tentative. **Clarified:** impersonation-hid-sessions was unconfirmed hypothesis; real annoyance = WB-NEW-SESSION-FALSE-RECOVERY (decision pending). **Ratified 2026-06-11:** wall-clock metering. **Lawyer-needed:** VPC method/copy, retention in /privacy, FERPA/SOPIPA. **Backlogged wiring:** learner-join-link, separate-tab opt-in, wordmark nav. |
| **In-flight subagents** | **NONE — overnight chain complete.** P2 executor DONE @ [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca); P3 plan [`58ca872`](https://github.com/Arangarx/tutoring-notes/commit/58ca872) + independent 5-axis [`0c92644`](https://github.com/Arangarx/tutoring-notes/commit/0c92644) DONE (blockers folded). Login-friction/auth thread **CLOSED** @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344). |
...
| **P2 student-on-new-shell (COMPLETE+smokeable 2026-06-16 — awaits Andrew smoke)** | **DONE** on `phase2/wb-student-new-shell` @ [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca) (forked off `v1-redesign` @ `f68053c`). Flag `NEXT_PUBLIC_WB_STUDENT_NEW_SHELL=1` routes `/w/[joinToken]` → `WhiteboardSessionShell` `role=student` (`StudentLiveWorkspaceClient` — `LiveBoardChrome`, sync/canvas/A/V from legacy, self-view ON, B4 disclosure, E2E sync bridge, pencil+eraser, follow controls); legacy `StudentWhiteboardClient` preserved as fallback. Gates: tsc/eslint clean, jest **660**, full `test:wb-sync` **13/1-skip (B1 flag-ON)**, `next build` 0. Blockers B1–B4 all met; NO tutor-engine behavioral change. Docs: plan [`f9355cc`](https://github.com/Arangarx/tutoring-notes/commit/f9355cc) → 5-axis [`26d6211`](https://github.com/Arangarx/tutoring-notes/commit/26d6211) → folded [`80ac571`](https://github.com/Arangarx/tutoring-notes/commit/80ac571); `WHITEBOARD-P2-STATUS.md`; `PLATFORM-ASSUMPTIONS` §10.10a. **Smokebook** [`phase-2-student-new-shell-smokebook-2026-06-16.md`](phase-2-student-new-shell-smokebook-2026-06-16.md) (items 0–15; #15 Q7 tutor regression). Preview: [phase2 @ Vercel](https://tutoring-notes-git-phase2-wb-stu-9fb9ae-arangarx-5209s-projects.vercel.app). **Q1/Q7 resolved.** **Next: Andrew sets flag on Preview + two-device smoke → `merge --no-ff` on PASS.** |
...
| **Uncommitted / unmerged** | **ONE unmerged feature branch off `v1-redesign`:** `phase1/wb-reliability-floor` @ `d63ac22` — 1b audio-clock + 3-tier iOS-safe fallback (merge after Andrew **DESKTOP** smoke; iOS tighten-pass deferred-safe). **DONE/MERGED:** `phase1/wb-review-correct` → `v1-redesign` @ [`f68053c`](https://github.com/Arangarx/tutoring-notes/commit/f68053c); `auth/2fa-remember-device` @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344); `fix/preview-badge-copy-commit` @ [`feccae9`](https://github.com/Arangarx/tutoring-notes/commit/feccae9). **SMOKEABLE — awaits Andrew smoke → merge:** `phase2/wb-student-new-shell` @ [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca) (student-on-new-shell, all gates green incl B1 wb-sync flag-ON; flag-gated, legacy preserved). **Known pre-existing:** `identity-2fa-management` stale jest assertion; `test:wb-sync` broadcast-throttle half fail (acceptable). **Reset-screen generate-offer → BL-RESET-GENERATE** (backlog). |
