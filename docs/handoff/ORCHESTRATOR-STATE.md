...
| Field | Value |
|---|---|
| **Last action completed (2026-06-16)** | **`phase1/wb-review-correct` @ [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20)** — session fixes (continued): (1) **Replay CTA layout** [`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8): Replay CTA follows thumbnail (not bottom-pinned) + un-stretched/centered button — **CONFIRMED** by Andrew. (2) **Replay seek on load** [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08): resolve measured audio duration for LOADED recordings — scrub no longer seeks to 0 on hard-refreshed/stored recording; root cause: `seek()` clamped to PARTIAL finite `el.duration` (Chrome buffers part of WebM before real duration resolves); fix passes through (lets audio element self-clamp) + guards `play()` from yanking `currentTime` backward; 12/12 scrub tests — **PENDING** Andrew on-device re-smoke. (3) **Live-A/V late-add renegotiation** [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20): force renegotiation on late-added video track — tutor now sees student cam; root cause: student enabling cam after join fires `onnegotiationneeded` while initial audio negotiation in-flight → `setLocalDescription` throws `InvalidStateError` → Chrome doesn't reliably re-fire → video SDP never sent → tutor `ontrack` never fires; fix: `onnegotiationneeded` defers when not stable + `onsignalingstatechange` flushes `pendingRenegotiation`; `addLocalTrackToAllPeers` returns added vs skipped; new `triggerRenegotiationOnPeers`; `useLiveAV` branches add-path→renegotiate (not redundant `replaceTrack`); kept [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8) buffer as defense-in-depth; 109 tests pass — **PENDING** Andrew two-device LV-2 re-smoke. *(Earlier same session: replay center-match [`ed04279`](https://github.com/Arangarx/tutoring-notes/commit/ed04279); hero thumbnail pin [`a05abdf`](https://github.com/Arangarx/tutoring-notes/commit/a05abdf); live-A/V track buffer [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8); docs [`c63d6a7`](https://github.com/Arangarx/tutoring-notes/commit/c63d6a7).)* **Andrew-confirmed (real browser):** replay first-play starts at 0:00; live+replay center tracking; thumbnail-pin + button layout ([`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8)); #5 audio pauses when leaving replay to notes-hero (was thought open — now resolved); in-page delete warning (no `alert()`); notes/form across prominent↔docked; LV-1 self-view both sides; idempotency #13 tentative (will reconfirm); legacy standalone replay D1-D3 skipped. *(Prior milestone — 2026-06-14 login-friction/auth merged @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344); 2026-06-12 `v1-design-system` @ [`36727ea`](https://github.com/Arangarx/tutoring-notes/commit/36727ea).)* |
...
| **Next action(s)** | **PRE-MASTER gate = 2 re-smokes on `phase1/wb-review-correct` @ [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20):** (1) Replay scrub on a **hard-refreshed / stored** recording resumes from drop point, not 0 (fix [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08)). (2) LV-2 two-device: student enables cam after joining → tutor sees live student tile within a few seconds (fix [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20)). Smokebook [`phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md`](phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md) — Andrew actively entering results (**do NOT edit**). **Once both pass →** `npm run test:wb-sync` + merge `--no-ff` to `v1-redesign`/`master`. Everything else confirmed or deferred. **(2) P2 student-shell** execute-ready @ [`80ac571`](https://github.com/Arangarx/tutoring-notes/commit/80ac571) — awaiting greenlight (unchanged). **(3) Prior threads:** `phase1/wb-reliability-floor` @ `d63ac22` merge after Andrew desktop smoke; Gate A→A6 unchanged; `Experience-Driven Wedge` program + consent v2 when Andrew prioritizes. **Deferred post-master (Andrew 2026-06-16, captured in BACKLOG):** DRY viewport consolidation (**WB-DRY-VIEWPORT**), review transition animation polish (**WB-REVIEW-TRANSITION**), impersonation session-recovery bypass (**WB-IMPERSONATION-SESSION**). |
| **Open Andrew-confirms** | **P1 replay (2026-06-16) — confirmed:** replay first-play starts at 0:00 ✓; live+replay center tracking ✓; thumbnail-pin + button layout ([`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8)) ✓; #5 audio pauses when leaving replay to notes-hero ✓ (was thought open — now resolved); in-page delete warning (no `alert()`) ✓; notes/form across prominent↔docked ✓; LV-1 self-view both sides ✓; idempotency #13 tentative (will reconfirm); legacy standalone replay D1-D3 skipped. **Pending re-smoke (pre-master gate — 2 items):** (1) replay scrub on hard-refreshed/stored recording resumes from drop point, not 0 ([`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08)); (2) LV-2 two-device late-add cam ([`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20)). **Resolved — deferred post-master:** DRY consolidation, transition animation #2, impersonation bypass → [`BACKLOG.md`](../BACKLOG.md) § P1 replay-in-frame post-master follow-ups. **Standing:** (c) student URL · (d) learner-swap · (e) student camera default · (f) C1–C4 · (g) env scoping · B2 D-1/D-2/D-5 · B1 deferred TODOs · N-2. **P2 Q1/Q7** branch strategy + `defaultShowLocalVideo`. **Ratified 2026-06-11:** wall-clock metering. **Lawyer-needed:** VPC, retention, FERPA/SOPIPA. |
...
| **P1 replay-in-frame (ACTIVE thread 2026-06-16)** | Branch `phase1/wb-review-correct` @ [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20) — unified in-frame review surface. **Session fixes (2026-06-16):** replay CTA follows thumbnail [`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8) ✓; replay seek-on-load [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08) (12/12 scrub tests); live-A/V late-add renegotiation [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20) (109 tests); replay center-match per frame [`ed04279`](https://github.com/Arangarx/tutoring-notes/commit/ed04279); hero thumbnail pin [`a05abdf`](https://github.com/Arangarx/tutoring-notes/commit/a05abdf); live-A/V track buffer [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8). **Andrew-confirmed:** replay first-play at 0:00; live+replay center; thumbnail-pin + button layout; #5 audio pause on notes-hero exit; delete warning; notes/form dock toggle; LV-1; audio seek/header/volume/thumbnail-dark/resize-recenter (prior fixes). **Pending re-smoke (pre-master — 2 items):** hard-refresh stored-recording scrub ([`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08)); LV-2 late-add cam ([`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20)). **Deferred post-master (BACKLOG):** transition animation polish; DRY viewport consolidation; impersonation session-recovery bypass. Smokebook [`phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md`](phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md) — Andrew actively entering results (**do NOT edit**). Prior FIX 1–7 + WebM duration + seek-storm + resize-recenter chain still in place. |
...
| **Live-A/V tutor video regression (FIXED 2026-06-16)** | **LV-1 CONFIRMED** (Andrew real browser): tutor self-view + student sees self + tutor. **LV-2 fixes:** (1) per-peer pending-track buffer @ [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8) — student's `ontrack` arriving before sync presence no longer drops track; kept as defense-in-depth. (2) **Late-add renegotiation @ [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20):** student enabling cam after join — `onnegotiationneeded` defers when not stable + `onsignalingstatechange` flushes pending renegotiation; `triggerRenegotiationOnPeers`; 109 tests pass. **Awaits Andrew two-device re-smoke:** student enables cam after joining → tutor sees live student tile within a few seconds. Prior tutor cam-acquisition fix (`682fc15`/`add3b81`) + tile-body min-height still in place. Part of ship-to-Sarah gate (A2 A/V verify). Student-side A/V cluster unification in P2. `test:wb-sync` owed pre-merge. |
| **Uncommitted / unmerged** | **TWO unmerged branches off `v1-redesign`:** (1) `phase1/wb-reliability-floor` @ `d63ac22` — 1b audio-clock + 3-tier iOS-safe fallback (merge after Andrew DESKTOP smoke). (2) **`phase1/wb-review-correct` @ [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20)** — in-frame unified review surface + full replay/A/V fix chain (seek-on-load [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08), late-add renegotiation [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20), CTA layout [`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8), center-match, thumbnail pin, track buffer, audio seek, WebM duration, seek-storm, resize-recenter). **Andrew actively smoking** via [`phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md`](phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md) — do NOT edit. **Confirmed:** replay first-play at 0:00; live+replay center; thumbnail-pin + button layout; #5 audio pause on notes-hero exit; delete warning; notes/form dock; LV-1; audio seek/header/volume/thumbnail-dark/resize-recenter. **Pending re-smoke (2 items):** hard-refresh stored-recording scrub; LV-2 late-add cam. **If both pass →** `npm run test:wb-sync` + merge `--no-ff` to `v1-redesign`. **DONE/MERGED:** `auth/2fa-remember-device` @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344); `fix/preview-badge-copy-commit` @ [`feccae9`](https://github.com/Arangarx/tutoring-notes/commit/feccae9). **Known pre-existing:** `identity-2fa-management` stale jest assertion; `test:wb-sync` broadcast-throttle half fail (pre-existing, not redesign). **Reset-screen generate-offer → BL-RESET-GENERATE** (backlog). |
