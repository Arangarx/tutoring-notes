...
| **Next action(s)** | **Andrew smoke** [`phase-2-student-new-shell-smokebook-2026-06-16.md`](phase-2-student-new-shell-smokebook-2026-06-16.md) on [branch preview](https://tutoring-notes-git-phase2-wb-stu-9fb9ae-arangarx-5209s-projects.vercel.app) → on PASS **`merge --no-ff`** `phase2/wb-student-new-shell` into `v1-redesign`. Then **(1b) P3 PLAN dispatch** ([`58ca872`](https://github.com/Arangarx/tutoring-notes/commit/58ca872)/[`0c92644`](https://github.com/Arangarx/tutoring-notes/commit/0c92644)) after greenlight. **(2)** `phase1/wb-reliability-floor` @ `d63ac22` — merge after Andrew **DESKTOP** smoke. **(3)** Ship-to-Sarah gate (SSG-1/2/3, F1). **Near-immediate post-master:** full product usage instrumentation (Andrew 2026-06-17; reclassified from pre-master gate — [`BACKLOG.md`](../BACKLOG.md) § Near-immediate post-master priorities). **Deferred post-master (BACKLOG):** WB-DRY-VIEWPORT, WB-REVIEW-TRANSITION, WB-IMPERSONATION-SESSION, WB-ERASE-RELIABILITY, WB-NEW-SESSION-FALSE-RECOVERY, WB-COMPONENTS-PASS, WB-AV-VIDEO-PAINT-REAL-FIX, WB / site composition + de-duplication audit, **WB-D6** student asset inserts. |
