...
## ⏩ HEAD — 2026-06-17 P2 student shell REWORKING to full tutor-parity-minus-5-deltas (Andrew scope correction); A/V cluster shrink-on-leave @ [`974fc87`](https://github.com/Arangarx/tutoring-notes/commit/974fc87); 5-delta contract durable in P2 plan banner + AGENTS.md lesson; P3 plan+5axis execute-ready
...
| **Next action(s)** | **(1) P2 student-on-new-shell — REWORKING to full tutor-parity-minus-5-deltas** (Andrew 2026-06-17 scope correction). Branch `phase2/wb-student-new-shell` head [`974fc87`](https://github.com/Arangarx/tutoring-notes/commit/974fc87). Route hard-switch @ [`23e1cba`](https://github.com/Arangarx/tutoring-notes/commit/23e1cba) already landed; A/V cluster shrink-on-leave @ [`974fc87`](https://github.com/Arangarx/tutoring-notes/commit/974fc87). **Scope correction:** student shell = tutor workspace IN FULL (chrome + toolset) minus D1–D5 (+ D6 pending); remove `AVPermissionsPrompt`, auto-enable A/V; 5-delta contract durable in plan banner + AGENTS.md lesson. Executor reworking `StudentLiveWorkspaceClient` to compose shared chrome; gates + updated smokebook → Andrew re-smoke → `merge --no-ff` into `v1-redesign`. Smokebook [`phase-2-student-new-shell-smokebook-2026-06-16.md`](phase-2-student-new-shell-smokebook-2026-06-16.md). **(1b) P3 PLAN + 5-AXIS execute-ready** ([`58ca872`](https://github.com/Arangarx/tutoring-notes/commit/58ca872)/[`0c92644`](https://github.com/Arangarx/tutoring-notes/commit/0c92644), 5 blockers folded P3-A1..A5) — dispatch after P2 merge + greenlight. **(2)** `phase1/wb-reliability-floor` @ `d63ac22` — merge after Andrew **DESKTOP** smoke (1b audio-clock; iOS tighten-pass deferred-safe, not merge gate). **(3)** Ship-to-Sarah gate (SSG-1/2/3, F1) — folds into P2/P3 + backend pass. **(4)** `Experience-Driven Wedge` rolling-wave + consent v2 when Andrew prioritizes. **Decision pending:** WB-NEW-SESSION-FALSE-RECOVERY — pre-master vs post-master. **Deferred post-master (BACKLOG):** WB-DRY-VIEWPORT, WB-REVIEW-TRANSITION, WB-IMPERSONATION-SESSION, WB-ERASE-RELIABILITY, WB-NEW-SESSION-FALSE-RECOVERY, WB-COMPONENTS-PASS, WB-AV-VIDEO-PAINT-REAL-FIX. |
...
| **In-flight subagents** | **1 RUNNING (Composer):** P2 student-shell full-parity rework on `phase2/wb-student-new-shell` — Andrew 2026-06-17 scope correction (tutor parity minus 5 deltas). **DONE:** A/V cluster shrink-on-peer-leave @ [`974fc87`](https://github.com/Arangarx/tutoring-notes/commit/974fc87); P2 executor [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca); hard-switch [`23e1cba`](https://github.com/Arangarx/tutoring-notes/commit/23e1cba); P3 plan [`58ca872`](https://github.com/Arangarx/tutoring-notes/commit/58ca872) + 5-axis [`0c92644`](https://github.com/Arangarx/tutoring-notes/commit/0c92644). Login-friction/auth CLOSED @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344). |
...
| **P2 student-on-new-shell (REWORKING 2026-06-17 — full tutor-parity-minus-5-deltas)** | Executor DONE @ [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca); hard-switched @ [`23e1cba`](https://github.com/Arangarx/tutoring-notes/commit/23e1cba); A/V cluster shrink-on-leave @ [`974fc87`](https://github.com/Arangarx/tutoring-notes/commit/974fc87). **Andrew 2026-06-17 scope correction:** student shell = tutor workspace IN FULL minus D1–D5 (+ D6 pending); slim student design SUPERSEDED. 5-delta contract durable in plan banner + AGENTS.md lesson. Reworking `StudentLiveWorkspaceClient` to compose shared chrome (remove `AVPermissionsPrompt`, auto-enable A/V, full tool strip, read-only page strip, Exit, student-color laser). Plan/5-axis: [`phase-2-student-on-new-shell-plan-2026-06-16.md`](phase-2-student-on-new-shell-plan-2026-06-16.md) + [`phase-2-student-on-new-shell-5axis-2026-06-16.md`](phase-2-student-on-new-shell-5axis-2026-06-16.md). Smokebook [`phase-2-student-new-shell-smokebook-2026-06-16.md`](phase-2-student-new-shell-smokebook-2026-06-16.md). **On re-smoke PASS → `merge --no-ff` into `v1-redesign`.** |
