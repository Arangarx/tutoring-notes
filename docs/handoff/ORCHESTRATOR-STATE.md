...
| **Uncommitted / unmerged** | **UNMERGED:** branch `phase1/wb-reliability-floor` (off `v1-redesign`, pushed @ `636dc92`) holds Phase 1 plan + 5-axis + 1b-diff-review docs AND the **1b audio-clock implementation (VERIFIED-CLEAN, awaiting Andrew iOS smoke — do NOT merge until smoked)**. `v1-redesign` tree clean, in sync with origin. **NOT yet merged to v1-redesign; 1c not started.** |
