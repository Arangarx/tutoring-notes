...
| WS-E E6 (student mic persistence) | ⬜ IN PROGRESS | A/V surface (useLiveAV/storage — additive persist, NOT reconnect logic); learner-scoped key mirror video pattern. Relay teeth. |
