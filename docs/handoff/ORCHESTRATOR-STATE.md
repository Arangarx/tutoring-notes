...
| **Next action(s)** | **DECISION TREE — await Andrew LV-2 test of [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) @ branch tip [`68be71f`](https://github.com/Arangarx/tutoring-notes/commit/68be71f):** LV-2 two-device — student enables cam after joining → tutor sees student video **paint on arrival WITHOUT** manual cluster resize; resize still scales both tiles smoothly (no squish). *(Scrub re-smoke [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08) — **CONFIRMED**.)* Smokebook [`phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md`](phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md) — Andrew actively entering results (**do NOT edit**). **(a) If student video paints on its own @ [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) →** keep clean CSS-only fix; pre-master gate cleared → `npm run test:wb-sync` + merge `--no-ff` to `v1-redesign`/`master`. **(b) If still black until resize →** **FALL BACK:** restore Mechanisms A+B from [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) (guaranteed working bandaid — `git show 3b996ae` for `WbAVCluster.tsx` + `AVTile.tsx`) **on top of** the current CSS fix ([`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2)), commit, add BACKLOG item **WB-AV-VIDEO-PAINT-REAL-FIX:** replace the auto-resize bandaid with a principled fix (CSS aspect-ratio change may or may not be sufficient alone). **Either way the branch MUST end in a state where the tutor sees the student video without manual resize.** Everything else confirmed or deferred. **Decision pending:** WB-NEW-SESSION-FALSE-RECOVERY (stale IndexedDB recovery banner on new sessions) — pull forward pre-master vs leave post-master (Andrew asked). **(2) P2 student-shell** execute-ready @ [`80ac571`](https://github.com/Arangarx/tutoring-notes/commit/80ac571) — awaiting greenlight (unchanged). **(3) Prior threads:** `phase1/wb-reliability-floor` @ `d63ac22` merge after Andrew desktop smoke; Gate A→A6 unchanged; `Experience-Driven Wedge` program + consent v2 when Andrew prioritizes. **Deferred post-master (Andrew 2026-06-16, captured in BACKLOG):** DRY viewport consolidation (**WB-DRY-VIEWPORT**), review transition animation polish (**WB-REVIEW-TRANSITION**), impersonation session-recovery bypass (**WB-IMPERSONATION-SESSION**), eraser reliability + partial erase (**WB-ERASE-RELIABILITY**), new-session false recovery banner (**WB-NEW-SESSION-FALSE-RECOVERY**), WB componentization tech-debt (**WB-COMPONENTS-PASS**). |
| **Open Andrew-confirms** | **P1 replay (2026-06-16) — confirmed:** replay first-play starts at 0:00 ✓; live+replay center tracking ✓; thumbnail-pin + button layout ([`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8)) ✓; #5 audio pauses when leaving replay to notes-hero ✓; hard-refresh stored-recording scrub ([`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08)) ✓; in-page delete warning (no `alert()`) ✓; notes/form across prominent↔docked ✓; LV-1 self-view both sides ✓; **🚨 [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) bandaid — remote video paints on arrival WITHOUT manual resize ✓ (KNOWN-GOOD CHECKPOINT)**; idempotency #13 tentative (will reconfirm); legacy standalone replay D1-D3 skipped. **Pending re-smoke (pre-master gate — 1 item):** LV-2 two-device @ [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) — does the **clean CSS-only fix** (bandaid removed) still paint on arrival? If not → fall back to [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) Mechanisms A+B on top of CSS fix. **Clarified (Andrew 2026-06-16):** earlier "impersonation hid the sessions" was an **UNCONFIRMED hypothesis** — NOT the real cause (Continue/open-sessions list shows normally). Real recurring annoyance = **WB-NEW-SESSION-FALSE-RECOVERY** (stale IndexedDB recovery banner on new sessions) — already in BACKLOG; **decision still pending** pre-master vs post-master. **Resolved — deferred post-master:** DRY consolidation, transition animation #2, impersonation bypass, eraser reliability → [`BACKLOG.md`](../BACKLOG.md) § P1 replay-in-frame post-master follow-ups. **Standing:** (c) student URL · (d) learner-swap · (e) student camera default · (f) C1–C4 · (g) env scoping · B2 D-1/D-2/D-5 · B1 deferred TODOs · N-2. **P2 Q1/Q7** branch strategy + `defaultShowLocalVideo`. **Ratified 2026-06-11:** wall-clock metering. **Lawyer-needed:** VPC, retention, FERPA/SOPIPA. |
...
| **P1 replay-in-frame (ACTIVE thread 2026-06-16)** | Branch `phase1/wb-review-correct` @ [`68be71f`](https://github.com/Arangarx/tutoring-notes/commit/68be71f). **🚨 KNOWN-GOOD:** [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) bandaid (Mechanisms A+B) — Andrew-CONFIRMED paints remote video on arrival. **Under test:** [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) clean CSS fix (A3b removed, bandaid removed) — UNPROVEN. Fix chain: [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8) → [`40b3130`](https://github.com/Arangarx/tutoring-notes/commit/40b3130) → [`a3a94f7`](https://github.com/Arangarx/tutoring-notes/commit/a3a94f7) → [`e2c290a`](https://github.com/Arangarx/tutoring-notes/commit/e2c290a) → [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) (WORKS) → [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) (unproven). **Session fixes (2026-06-16):** replay CTA [`8380bf8`](https://github.com/Arangarx/tutoring-notes/commit/8380bf8) ✓; seek-on-load [`1240c08`](https://github.com/Arangarx/tutoring-notes/commit/1240c08) ✓; late-add renegotiation [`cbe6d20`](https://github.com/Arangarx/tutoring-notes/commit/cbe6d20); play()+resize [`40b3130`](https://github.com/Arangarx/tutoring-notes/commit/40b3130); paint attempts 3–6 [`a3a94f7`](https://github.com/Arangarx/tutoring-notes/commit/a3a94f7)/[`e2c290a`](https://github.com/Arangarx/tutoring-notes/commit/e2c290a)/[`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae)/[`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2); center-match [`ed04279`](https://github.com/Arangarx/tutoring-notes/commit/ed04279); thumbnail pin [`a05abdf`](https://github.com/Arangarx/tutoring-notes/commit/a05abdf); track buffer [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8); backlog doc [`68be71f`](https://github.com/Arangarx/tutoring-notes/commit/68be71f). **Andrew-confirmed:** replay first-play at 0:00; live+replay center; thumbnail-pin + button layout; #5 audio pause; hard-refresh scrub; delete warning; notes/form dock; LV-1; **[`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) video paint-on-arrival (bandaid)**. **Pending:** LV-2 @ [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) — clean fix; fallback = restore A+B from [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae). **Deferred post-master (BACKLOG):** transition animation; DRY viewport; impersonation bypass; eraser reliability (**WB-ERASE-RELIABILITY**); false recovery (**WB-NEW-SESSION-FALSE-RECOVERY**, decision pending); componentization (**WB-COMPONENTS-PASS**). Smokebook [`phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md`](phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md) — Andrew actively entering results (**do NOT edit**). |
...
| **Live-A/V tutor video regression (IN PROGRESS 2026-06-16)** | **LV-1 CONFIRMED.** **🚨 KNOWN-GOOD CHECKPOINT [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae): BANDAID WORKS (Andrew-CONFIRMED)** — Mechanisms A (`WbAVCluster` auto-setSize+setUserResized on remote-video arrival) + B (`AVTile` ResizeObserver + offsetHeight flush) paint remote student video on arrival without manual resize. **Guaranteed fallback — DO NOT LOSE.** **LV-2 fix chain:** [`3261da8`](https://github.com/Arangarx/tutoring-notes/commit/3261da8) → [`40b3130`](https://github.com/Arangarx/tutoring-notes/commit/40b3130) → [`a3a94f7`](https://github.com/Arangarx/tutoring-notes/commit/a3a94f7) → [`e2c290a`](https://github.com/Arangarx/tutoring-notes/commit/e2c290a) → [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) (**WORKS — bandaid**) → [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) (clean CSS-only, **UNPROVEN**, bandaid removed). **Await Andrew LV-2 @ [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2):** (a) paints → keep clean fix; (b) still black → restore A+B from [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) on top of CSS fix + BACKLOG `WB-AV-VIDEO-PAINT-REAL-FIX`. Branch must end with video painting without manual resize either way. Scrub confirmed. `test:wb-sync` owed pre-merge. |
| **Uncommitted / unmerged** | **TWO unmerged branches off `v1-redesign`:** (1) `phase1/wb-reliability-floor` @ `d63ac22` — 1b audio-clock + 3-tier iOS-safe fallback (merge after Andrew DESKTOP smoke). (2) **`phase1/wb-review-correct` @ [`68be71f`](https://github.com/Arangarx/tutoring-notes/commit/68be71f)** — in-frame unified review surface + full replay/A/V fix chain. **🚨 KNOWN-GOOD bandaid @ [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) (Andrew-CONFIRMED).** Under test: [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) clean CSS fix (bandaid removed). **Andrew actively smoking** via [`phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md`](phase-1-wb-floor-replay-in-frame-smokebook-2026-06-14.md) — do NOT edit. **Confirmed:** scrub; replay first-play; live+replay center; thumbnail-pin; #5 audio pause; delete warning; notes/form dock; LV-1; **[`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae) video paint (bandaid)**. **Pending (1 item):** LV-2 @ [`caaabf2`](https://github.com/Arangarx/tutoring-notes/commit/caaabf2) — clean fix; fallback = restore A+B from [`3b996ae`](https://github.com/Arangarx/tutoring-notes/commit/3b996ae). **If passes (either path) →** `npm run test:wb-sync` + merge `--no-ff` to `v1-redesign`. **DONE/MERGED:** `auth/2fa-remember-device` @ [`8ffd344`](https://github.com/Arangarx/tutoring-notes/commit/8ffd344); `fix/preview-badge-copy-commit` @ [`feccae9`](https://github.com/Arangarx/tutoring-notes/commit/feccae9). **Known pre-existing:** `identity-2fa-management` stale jest assertion; `test:wb-sync` broadcast-throttle half fail (pre-existing, not redesign). **Reset-screen generate-offer → BL-RESET-GENERATE** (backlog). |
