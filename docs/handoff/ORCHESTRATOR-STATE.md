...
4. **IN FLIGHT** — Pause/disconnect/draw-during-disconnect **code analysis** (read-only → analysis doc) — the code-half of session-lifecycle/LTX P0 prep; hardware-half waits for Andrew.
