...
| **Uncommitted / unmerged** | Branch `wb-wave5-polish` at [`c26f7ce`](https://github.com/Arangarx/tutoring-notes/commit/c26f7ce) (WS-H) + this docs commit on top, all pushed, unmerged (merge = Andrew hard stop). No code uncommitted at time of this write. |
