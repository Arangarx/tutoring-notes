...
## ⏩ HEAD — 2026-06-17 P2 student shell IN PROGRESS; interim full-parity rework resumed on Andrew explicit GO (shared components, no bespoke); tutor parity minus 5 deltas (+ D6 pending)
...
| **Next action(s)** | **(1) P2 student-on-new-shell — IN PROGRESS (Andrew GO 2026-06-17).** Interim full-parity rework on `phase2/wb-student-new-shell` @ [`cf7e4a7`](https://github.com/Arangarx/tutoring-notes/commit/cf7e4a7): compose shared chrome (no bespoke), tutor-parity minus D1–D5 (+ D6 pending) per plan banner + composition rule. On rework complete: gates + smokebook update + push → Andrew re-smoke → `merge --no-ff` into `v1-redesign`. Smokebook [`phase-2-student-new-shell-smokebook-2026-06-16.md`](phase-2-student-new-shell-smokebook-2026-06-16.md). **(1b) P3 PLAN + 5-AXIS execute-ready** ([`58ca872`](https://github.com/Arangarx/tutoring-notes/commit/58ca872)/[`0c92644`](https://github.com/Arangarx/tutoring-notes/commit/0c92644), 5 blockers folded P3-A1..A5) — dispatch after P2 merge + greenlight. **(2)** `phase1/wb-reliability-floor` @ `d63ac22` — merge after Andrew **DESKTOP** smoke (1b audio-clock; iOS tighten-pass deferred-safe, not merge gate). **(3)** Ship-to-Sarah gate (SSG-1/2/3, F1) — folds into P2/P3 + backend pass. **(4)** `Experience-Driven Wedge` rolling-wave + consent v2 when Andrew prioritizes. **Decision pending:** WB-NEW-SESSION-FALSE-RECOVERY — pre-master vs post-master. **Deferred post-master (BACKLOG):** WB-DRY-VIEWPORT, WB-REVIEW-TRANSITION, WB-IMPERSONATION-SESSION, WB-ERASE-RELIABILITY, WB-NEW-SESSION-FALSE-RECOVERY, WB-COMPONENTS-PASS, WB-AV-VIDEO-PAINT-REAL-FIX, WB / site composition + de-duplication audit. |
...
| **P2 student-on-new-shell (IN PROGRESS 2026-06-17 — Andrew GO)** | Executor DONE @ [`93d71ca`](https://github.com/Arangarx/tutoring-notes/commit/93d71ca); hard-switched @ [`23e1cba`](https://github.com/Arangarx/tutoring-notes/commit/23e1cba); A/V cluster shrink-on-leave @ [`974fc87`](https://github.com/Arangarx/tutoring-notes/commit/974fc87); 5-delta contract @ [`47a9ea3`](https://github.com/Arangarx/tutoring-notes/commit/47a9ea3); scope + composition rule @ [`cf7e4a7`](https://github.com/Arangarx/tutoring-notes/commit/cf7e4a7). **Interim full-parity rework IN PROGRESS** — `StudentLiveWorkspaceClient` composed from shared chrome, tutor-parity minus D1–D5 (+ D6 pending). Plan/5-axis: [`phase-2-student-on-new-shell-plan-2026-06-16.md`](phase-2-student-on-new-shell-plan-2026-06-16.md) + [`phase-2-student-on-new-shell-5axis-2026-06-16.md`](phase-2-student-on-new-shell-5axis-2026-06-16.md). Smokebook [`phase-2-student-new-shell-smokebook-2026-06-16.md`](phase-2-student-new-shell-smokebook-2026-06-16.md). **On re-smoke PASS → `merge --no-ff` into `v1-redesign`.** |
