...
| **In-flight subagents** | **Explore** mapping current student/parent session-access wiring (live-join token vs share link vs learner/parent login vs session↔learner ownership) to ground the authed-access design. A3a/A3b + graph-latency merged. |
