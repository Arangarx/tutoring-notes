...
- **2026-07-05:** plan captured. Executing SERIALLY (dispatch-safety note).
  ...
  - **P1-J4** ⏳ IN FLIGHT ([impl](7174c575-fa9e-47be-b0f9-5d94b114d513)) — `loadSessionReviewPayload` non-empty vs honest-empty + ownership (WS-S); `attachWhiteboardToNoteAction` linkage + cross-tenant. Supersedes RW-4.
  - NEXT (serial): P1-J5 replay-mixdown/concat route auth → P1-J6/J7/J8 (throttle/hard-stop/shimmer). Then the SERIAL-ONLY relay + identity-e2e groups (one at a time).
