...
- **2026-07-05:** plan captured. Executing SERIALLY (dispatch-safety note).
  ...
  - **P1-J8** ⏳ IN FLIGHT ([impl](130fe7b7-e37d-49f7-aaf2-5229004cf06f)) — notes-shimmer NON-transparent computed style / defined-CSS-var guard + reduced-motion (item 16; catches the undefined-var invisible-regression class). Last pure-jest P1-J batch.
  - NEXT: pure-jest P2 batches (P2-J2 note-time snap, P2-J4 share mark-seen client) continue serial; SERIAL-ONLY relay (P1-WB-*) + identity-e2e (P1-ID-*) groups authored one-at-a-time after (heavier, need relay/dev-server).
