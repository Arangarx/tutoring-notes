...
- **2026-07-05:** plan captured. Executing SERIALLY (dispatch-safety note).
  ...
  - **🔧 TEST-ONLY FIX IN FLIGHT ([stale-test fix](a40a36cc-104c-4087-b6eb-138f27eef77c))** — update av-mount student test (expect caret+gain, no chime) + ReplayInFrame tests (drive WebM scan to completion before asserting Pause; monotonic-resolved re-entry). NO production change. Verifies FULL jest green after.
