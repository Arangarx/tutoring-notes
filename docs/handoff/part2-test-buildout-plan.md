...
- **2026-07-05:** plan captured. Executing SERIALLY (dispatch-safety note).
  ...
  - **P1-J6** ⏳ IN FLIGHT ([impl](f0ccf01f-4ea4-4789-ac30-a08099eafb02)) — AH-login throttle DB-durability across cold start (mirrors learner-pin durability); flags if memory-only.
  - NEXT (serial): P1-J7 hard-stop UI seam → P1-J8 notes-shimmer computed style. Then the SERIAL-ONLY relay + identity-e2e groups (one at a time).
