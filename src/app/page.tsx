    ...
    <>
      ...
      <main id="main-content">
        ...
        >
          ...
          >
            No commission on your tutoring rate
          </p>
        ...
        >
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16 }}>
            <ValuePropCard
              ...
              body="Hit record. Mynk transcribes the session and drafts your recap fields — topics, assessment, and plan. Edit what you want, save, and send when you're ready to review."
            />
            <ValuePropCard
            ...
            <ValuePropCard
              ...
              headline="No commission on your tutoring rate"
              body="During the pilot, Mynk does not take a cut of what you charge. Your session data stays under your account — parent and student access is through secure sign-in, no ads, no tracking."
            />
          </div>
        </section>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  desc: "Teach the way you already do — Mynk runs in the background. When you're done, tap End Session; audio and whiteboard are saved.",
                },
                {
                  step: "03",
        ...
        >
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            >
              Mynk is free during the pilot. No credit card. No platform fee on
              your tutoring rate. Your account is protected by login — parent and
